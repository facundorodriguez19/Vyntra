(() => {
  ...
  const LANGUAGES = {
    es: { flag: '🇪🇸', label: 'Español', html: 'es' },
    pt: { flag: '🇧🇷', label: 'Português', html: 'pt-BR' },
  ...
  const COPY = {
    pt: {
      ...
      'Completa tus datos y paga con Stripe. Despues vas a poder seguir el estado del pedido desde la web.': 'Preencha seus dados e pague com Stripe. Depois você poderá acompanhar o status do pedido pelo site.',
      ...
      'Preparando pago seguro con Stripe...': 'Preparando pagamento seguro com Stripe...',
      ...
      'Si acabas de pagar, espera unos segundos y actualiza. Stripe puede tardar un momento en confirmar el pago.': 'Se acabou de pagar, aguarde alguns segundos e atualize. O Stripe pode demorar um momento para confirmar o pagamento.',
    ...
    en: {
      ...
      'Completa tus datos y paga con Stripe. Despues vas a poder seguir el estado del pedido desde la web.': 'Enter your details and pay with Stripe. Then you can track the order status from the website.',
      ...
      'Preparando pago seguro con Stripe...': 'Preparing secure Stripe payment...',
      'No se pudo iniciar el pago.': 'Payment could not be started.',
      'No se pudo iniciar el pago. Revisá la configuración de Stripe.': 'Payment could not be started. Check the Stripe configuration.',
      ...
      'Si acabas de pagar, espera unos segundos y actualiza. Stripe puede tardar un momento en confirmar el pago.': 'If you just paid, wait a few seconds and refresh. Stripe can take a moment to confirm the payment.',
