...
<nav>
  ...
  <div class="nav-end"><a class="nav-icon" href="temporada.html#lookbook">Lookbook</a><a class="nav-icon nav-auth-link" href="login.php" data-auth-login>Ingresar</a><a class="nav-icon nav-auth-link active" href="register.php" data-auth-register>Registro</a><button class="nav-cta" type="button">Carrito <span class="cart-count">0</span></button><button class="nav-ham" type="button" aria-label="Abrir menu" aria-controls="menu-mobile" aria-expanded="false">☰</button></div>
</nav>
