...
<nav>
  ...
  <div class="nav-end"><a class="nav-login-button nav-auth-link" href="login.php" data-auth-login>Login</a><button class="nav-cta" type="button">Carrito <span class="cart-count">0</span></button><button class="nav-ham" type="button" aria-label="Abrir menu" aria-controls="menu-mobile" aria-expanded="false">&#9776;</button></div>
</nav>
...
<main>
  <section class="auth-shell">
    ...
    <form class="auth-card" method="post" action="register.php" novalidate>
      ...
      <label>Contraseña<input type="password" name="password" placeholder="Mínimo 8 caracteres" minlength="8" required></label>
      <label>Confirmar contraseña<input type="password" name="password_confirm" placeholder="Repetí la contraseña" minlength="8" required></label>
      <button class="btn-outline-g" type="submit">Crear cuenta</button>
      <p class="auth-switch">¿Ya tenés cuenta? <a href="login.php">Ingresar</a></p>
    </form>
  </section>
</main>
...
<footer>
  <div class="foot-main">
    ...
    <nav class="foot-nav" aria-label="Secciones del sitio"><a href="index.html#sobre">Marca</a><a href="index.html#proceso">Proceso</a><a href="index.html#envios">Envíos</a><a href="index.html#contacto">Contacto</a></nav>
  </div>
